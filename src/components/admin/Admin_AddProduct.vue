...
<template>
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col overflow-auto">
            <navbarAdmin />
            <div class="flex-1 p-6 bg-gray-100 overflow-hidden">
                <div class="p-6 md:p-10 mb-8 overflow-y-auto max-h-[calc(100vh-150px)]">
                    <form action="/updateprofile" method="post" class="grid bg-white p-7 border-2 rounded-lg gap-6 text-sm grid-cols-1 md:grid-cols-5">
                        ...
                        <div class="md:col-span-5">
                            <label for="idBook" class="font-semibold text-[16px]">Mã sách</label>
                            <input type="text" name="idBook" id="idBook" value=""
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="Nhập mã sách" />
                        </div>

                        <div class="md:col-span-5">
                            <label for="idNXB" class="font-semibold text-[16px]">Mã nhà xuất bản</label>
                            <input type="text" name="idNXB" id="idNXB" value=""
                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                                placeholder="Tên nhà xuất bản" />
                        </div>

                        <div class="md:col-span-5">
                            <label for="name" class="font-semibold text-[16px]">Tên sách</label>
                        ...
                        <div class="flex flex-col justify-center w-full gap-2">
                            <label for="" class="font-semibold text-[16px]">Loại sách</label>
                            <select name="type"
                        ...
                        <div class="md:col-span-5">
                            <label for="quantity" class="font-semibold text-[16px]">Số quyển</label>
                        ...
                        <div class="md:col-span-5">
                            ...
                            <input type="file" name="image" id="image" value="" class="font-bold mt-2"
